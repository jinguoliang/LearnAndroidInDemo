...
public class UploadService extends IntentService {
    ...
    public void onCreate() {
        ...
        s3Client = new AmazonS3Client(
                new CognitoCachingCredentialsProvider(getApplicationContext(),
                        "us-east-1:c0202ae8-4b11-407e-bb84-a3d66cee370e",
                        Regions.US_EAST_1));
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Utils.log("the bubbu  = " + s3BucketName);
    ...
    private Notification buildNotification(String msg, int progress) {
        ...
        Intent notificationIntent = new Intent(this, S3simple.class);
